...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!EMAILJS_SERVICE_ID || !EMAILJS_TEMPLATE_ID || !EMAILJS_PUBLIC_KEY) {
      setStatus('error');
      setErrorMsg(
        'EmailJS não configurado. Verifique seu .env.local (SERVICE_ID, TEMPLATE_ID e PUBLIC_KEY).',
      );
      return;
    }
    ...
    try {
      ...
      // Esses nomes (name/email/subject/message) precisam bater com o Template do EmailJS
      await emailjs.send(
        EMAILJS_SERVICE_ID,
        EMAILJS_TEMPLATE_ID,
        {
            ...
            <div className="mt-6 grid gap-3">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-white/60">https://github.com/Zev1n</span>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-white/60">https://www.linkedin.com/in/henrique-azevedo-flores-278611235/</span>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-white/60">henriqueflores2003@gmail.com</span>
                </div>
              </a>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="mt-6 grid gap-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="grid gap-2">
                  ...
                  <input
                    ...
                    className="rounded-xl bg-white/5 px-4 py-3 text-sm text-white/90 outline-none ring-1 ring-white/10 transition focus:ring-[#00a6f4]/60"
              ...
              <div className="grid gap-2">
                ...
                <textarea
                  ...
                  className="min-h-[140px] resize-none rounded-xl bg-white/5 px-4 py-3 text-sm text-white/90 outline-none ring-1 ring-white/10 transition focus:ring-[#00a6f4]/60"
